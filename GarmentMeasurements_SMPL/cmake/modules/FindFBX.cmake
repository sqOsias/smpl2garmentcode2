...
message(FBX_EXT_DIR ${FBX_EXT_DIR})

if (APPLE)
    find_file(FBX_LIBRARY libfbxsdk.a "${FBX_EXT_DIR}lib/clang/release/")
elseif(UNIX)
    find_file(FBX_LIBRARY libfbxsdk.a "${FBX_EXT_DIR}lib/release")
elseif(WIN32)
...
message(isUnix ${UNIX})
message(FBX_LIBRARY ${FBX_LIBRARY})
message(FBX_INCLUDE ${FBX_INCLUDE})
