...
def evaluate_single_sample(npz_path: str,
    ...
    # # 临时测试手段：强行对齐 Y 轴中心
    y_shift = gt_pts[:, 1].mean() - pred_pts[:, 1].mean()
    pred_pts[:, 1] += y_shift
    # 打印点云统计信息，便于理解坐标系
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='/root/wyc/code/smpl2garmentcode2/AutoGarmentCode/output/CloSe/10010_2314/test')
    parser.add_argument('--single', type=str, default="10010_2314",
                        help='single sample evaluation, pass sample name like 10010_2314')
